...
{ id: 2, title: "ChatGPT & Advanced Prompt Engineering", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Mukammal promptlar yozish, Custom GPTs yaratish hamda kognitiv topshiriqlarni sun'iy intelektga topshirish.", duration: "4 Hafta", level: "O'rta", price: "249,000 UZS", icon: "fa-solid fa-code", badge: "Intensiv", lessonUrl: "ai-practical-productivity.html", modules: ["Few-Shot va Chain-of-Thought Prompting texnikalari", "Shaxsiy Custom GPT assistentlarini kodsiz yaratish", "Katta hajmdagi matnlar va kitoblarni umumlashtirish", "AI xatolarini (Hallucinations) oldini olish va tekshirish"] },
{ id: 3, title: "Midjourney & AI Visual Content Creation", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Professional dizayn, fotorealistik tasvirlar va visual presentation materiallarini AI yordamida yaratish.", duration: "3 Hafta", level: "Boshlang'ich", price: "199,000 UZS", icon: "fa-solid fa-palette", badge: "Kreativ", lessonUrl: "ai-midjourney-visual.html", modules: ["Midjourney v6 parametrlari va stil aralashmalari", "Fotorealistik portretlar va mahsulot dizaynlari", "DALL-E 3 va Canva AI bilan ijtimoiy tarmoq bannerlari", "AI orqali SMM va brending uchun vizual kontent"] },
{ id: 4, title: "AI Tools for Academic Research & Writing", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Ilmiy maqolalar, dissertatsiya va insholarni tahlil qilish, iqtiboslar bilan ishlash hamda tadqiqot AI vositalari.", duration: "4 Hafta", level: "Akademik", price: "299,000 UZS", icon: "fa-solid fa-book-open-reader", badge: "Talabalar uchun", lessonUrl: "ai-academic-research.html", modules: ["Consensus va Elicit AI bilan ilmiy maqolalarni izlash", "Litmaps yordamida adabiyotlar sharhini (Literature Review) tuzish", "Grammarly AI va Quillbot orqali akademik ingliz tilini takomillashtirish", "Plagiat va AI detection bilan ishlash strategiyasi"] },
{ id: 5, title: "Python + AI Foundations for Beginners", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Dasturlash tajribasisiz Python asoslarini o'rganish va OpenAI API orqali birinchi AI loyihangizni yoqish.", duration: "6 Hafta", level: "Boshlang'ich", price: "349,000 UZS", icon: "fa-brands fa-python", badge: "Praktikum", lessonUrl: "ai-python-foundations.html", modules: ["Python sintaksisi va ma'lumotlar tuzilmasi", "OpenAI API kalitini ulash va sorov yuborish", "Streamlit yordamida AI Web App interfeysi yaratish", "Shaxsiy AI chatbot loyihasini joylashtirish (Deploy)"] },
{ id: 6, title: "Automation with Claude & Make/Zapier", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Biznes va ish jarayonlarini kod yozmasdan avtomatlashtirish: Telegram botlar, CRM va elektron pochta integratsiyasi.", duration: "4 Hafta", level: "O'rta", price: "299,000 UZS", icon: "fa-solid fa-gears", badge: "Biznes AI", lessonUrl: "ai-automation-workflows.html", modules: ["Make.com va Zapier platformasi asoslari", "Telegram botga Claude API ulash", "Google Sheets va AI ma'lumotlar oqimini zanjirlash", "Avtomatik mijozlar xabarnomasi tizimini yoqish"] },
{ id: 7, title: "AI-Powered Data Analysis & Excel", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Katta ma'lumotlar bazasini AI va Code Interpreter orqali daqiqalar ichida tahlil qilish hamda grafiklar tuzish.", duration: "3 Hafta", level: "Amaliy", price: "249,000 UZS", icon: "fa-solid fa-chart-pie", badge: "Analitika", lessonUrl: "ai-data-analysis.html", modules: ["ChatGPT Advanced Data Analysis (Code Interpreter)", "Excel va Google Sheets formulalarini AI yordamida avtomatik tuzish", "Moliyaviy va sotuv statistikalarini vizuallashtirish", "Trendlarni bashorat qilish va hisobotlar tayyorlash"] },
{ id: 8, title: "Content Creation with AI (Copywriting & Video)", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Kopirayting, AI diktorlar (HeyGen, ElevenLabs) va qisqa videolar (Shorts/Reels) yaratish bosqichlari.", duration: "3 Hafta", level: "Boshlang'ich", price: "199,000 UZS", icon: "fa-solid fa-video", badge: "SMM & Media", lessonUrl: "ai-content-creation.html", modules: ["Kopirayting ssenariylari va ilgak matnlar yaratish", "ElevenLabs orqali tabiiy ovozli AI audiolarni shakllantirish", "HeyGen va CapCut AI bilan professional video montaj", "YouTube va Instagram uchun kontent konveyerini yoqish"] },
{ id: 9, title: "Generative AI for Students & Scholars", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Imtihonlarga tayyorgarlik, konspektlar tuzish va murakkab mavzularni tushuntiruvchi AI repetitor vositalari.", duration: "3 Hafta", level: "Boshlang'ich", price: "199,000 UZS", icon: "fa-solid fa-graduation-cap", badge: "Ta'lim", lessonUrl: "ai-for-students.html", modules: ["PDF va ma'ruzalardan avtomatik Flashcard va testlar yasash", "Feynman metodologiyasini ChatGPT orqali qo'llash", "Xorijiy tillarni AI so'zlashuvchi bilan o'rganish", "Vaqtni samarali boshqarish va taqvim AI tizimi"] },
{ id: 10, title: "AI Coding Assistant (Cursor & Copilot)", category: "ai", catName: "Sun'iy Intelekt (AI)", desc: "Cursor IDE, GitHub Copilot va AI yordamida 10x tezroq kod yozish hamda veb-sayt va ilovalar yaratish.", duration: "4 Hafta", level: "Amaliy", price: "299,000 UZS", icon: "fa-solid fa-laptop-code", badge: "Dasturchilar", lessonUrl: "ai-coding-assistant.html", modules: ["Cursor IDE o'rnatish va sozlash", "Koddagi buglarni AI bilan sekundlarda topish", "Refactoring va koding arxitekturasini yaxshilash", "Full-stack kichik ilovalarni AI bilan noldan qurish"] },

// --- IELTS CATEGORY (11 COURSES) ---
{ id: 11, title: "IELTS Writing Task 2 Masterclass", category: "ielts", catName: "IELTS & Ingliz tili", desc: "Insho turlari, aniq struktura andozalari, akademik lug'at hamda Band 7.0+ maqsad qilganlar uchun grammatik murakkablik.", duration: "4 Hafta", level: "Intermediate+", price: "349,000 UZS", icon: "fa-solid fa-pen-nib", badge: "Top Natija", lessonUrl: "ielts-writing-task2.html", modules: ["Opinion, Discussion, Advantage/Disadvantage insholar qolipi", "Paragraf mantiqiy bog'lanishi (Coherence & Cohesion)", "Band 7+ Akademik Collocation va sinonimlar", "Real insho namunalarini tahlil qilish va baholash"] },
{ id: 12, title: "IELTS Speaking Confidence & Accent Booster", category: "ielts", catName: "IELTS & Ingliz tili", desc: "Part 1, 2, 3 uchun ravon gapirish texnikasi, hayajonni yengish va imtihon oluvchini jalb qilish strategiyasi.", duration: "3 Hafta", level: "Barcha Darajalar", price: "249,000 UZS", icon: "fa-solid fa-comments", badge: "Amaliy So'zlashuv", lessonUrl: "ielts-speaking.html", modules: ["Part 2 Cue Card bo'yicha 1 minutda struktura tuzish", "Part 3 abstrakt savollarga chuqur javob berish", "Fluency va Hesitation o'rtasidagi muvozanat", "Mock speaking simulyatsiyasi va fikr-mulohazalar"] },
{ id: 13, title: "IELTS Reading Speed & Keyword Tracking Tech", category: "ielts", catName: "IELTS & Ingliz tili", desc: "Passage 1, 2, 3 ni 60 daqiqada tugatish, True/False/Not Given va Headings savollarini xatosiz yechish sirlari.", duration: "3 Hafta", level: "Intermediate+", price: "249,000 UZS", icon: "fa-solid fa-eye", badge: "Tezkor Usul", lessonUrl: "ielts-reading.html", modules: ["Skimming va Scanning texnikasini avtomatga chiqarish", "Paraphrase kalit so'zlarni tezkor payqash", "Matching Headings va Summary Completion xatosiz strategiyasi", "Vaqtni to'g'ri taqsimlash metodikasi"] },
{ id: 14, title: "IELTS Listening Full Prep & Accent Mastery", category: "ielts", catName: "IELTS & Ingliz tili", desc: "Britaniya, Avstraliya va Amerika aksentlarini tushunish, diqqatni jamlash va tuzoqli savollarni yengish.", duration: "3 Hafta", level: "Barcha Darajalar", price: "249,000 UZS", icon: "fa-solid fa-headphones", badge: "Intensiv", lessonUrl: "ielts-listening.html", modules: ["Part 3 & 4 ko'p tanlovli (Multiple Choice) savollar", "Distractors va chalg'ituvchi iboralarni aniqlash", "Map & Diagram labeling topshiriqlari", "Audiolarni 1.25x tezlikda mashq qilish usuli"] },
...
{ id: 22, title: "Digital SAT Math Mastery (800 Score Strategy)", category: "admission", catName: "Admission & SAT", desc: "Digital SAT Matematika bo'limining barcha formulalari, Desmos kalkulyatoridan samarali foydalanish hamda 800 bal algebrasi.", duration: "6 Hafta", level: "Amaliy", price: "399,000 UZS", icon: "fa-solid fa-calculator", badge: "Top 800", lessonUrl: "sat-strategy.html", modules: ["Algebra va Linear Equations tezkor yechimlari", "Desmos Graphing Calculator sirlari va layfhaklar", "Advanced Math, Geometry va Trigonometry", "Digital SAT modullari simulyatsiyasi va vaqtni tejash"] },
{ id: 23, title: "Digital SAT Reading & Writing", category: "admission", catName: "Admission & SAT", desc: "Digital SAT Reading matnlari tahlili, Vocabulary in Context hamda Grammatika qoidalarining 100% yechimlari.", duration: "6 Hafta", level: "Advanced", price: "399,000 UZS", icon: "fa-solid fa-pen-fancy", badge: "Intensiv", lessonUrl: "sat-strategy.html", modules: ["Craft and Structure savol turlarini yechish", "Information and Ideas matnli tahlil", "Expression of Ideas va Standard English Conventions", "SAT lug'at bazasi va tezkor matn o'qish"] },
...
// --- MATHEMATICS CATEGORY (2 COURSES) — Prompt 1 ---
{ id: 32, title: "Maktab Matematikasi (Algebra & Geometriya)", category: "math", catName: "Matematika", desc: "7–11 sinf o'quvchilari uchun algebra, geometriya va sonlar nazariyasi asoslari — darajaga mos holda.", duration: "4 Hafta", level: "7–11 sinf", price: "199,000 UZS", icon: "fa-solid fa-calculator", badge: "Maktab", modules: ["Tenglamalar va tengsizliklarni yechish", "Geometrik shakllar va ularning yuzalari", "Funksiyalar va grafiklar asoslari", "Kasrlar, foizlar va proporsiyalar"] },
{ id: 33, title: "Olimpiada va SAT Math Tayyorgarligi", category: "math", catName: "Matematika", desc: "Murakkab masalalar, mantiqiy fikrlash va SAT Math 800 ball strategiyasiga tayyorgarlik.", duration: "6 Hafta", level: "Advanced", price: "349,000 UZS", icon: "fa-solid fa-trophy", badge: "Olimpiada", modules: ["SAT Math formulalari va Desmos sirlari", "Mantiqiy va kombinatorika masalalari", "Geometriya va trigonometriya chuqurlashuvi", "Vaqtni boshqarish va test texnikasi"] },

// --- PHYSICS CATEGORY (2 COURSES) — Prompt 2 ---
{ id: 34, title: "Maktab Fizikasi (Mexanika & Elektr)", category: "physics", catName: "Fizika", desc: "Kinetika, dinamika, energiya va elektr zanjirlari — murakkab mavzularni sodda tushuntirish bilan.", duration: "4 Hafta", level: "7–11 sinf", price: "199,000 UZS", icon: "fa-solid fa-atom", badge: "Maktab", modules: ["Kuchlar, harakat va energiya saqlanishi", "Elektr zanjirlari va Om qonuni", "Optika va to'lqin hodisalari", "Amaliy masalalar va laboratoriya tajribalari"] },
{ id: 35, title: "Fizika Olimpiada Tayyorgarligi", category: "physics", catName: "Fizika", desc: "Respublika va xalqaro olimpiadalari uchun chuqur fizika va qiyin masalalar yechish.", duration: "6 Hafta", level: "Advanced", price: "349,000 UZS", icon: "fa-solid fa-bolt", badge: "Olimpiada", modules: ["Klassik mexanika va termodinamika", "Elektromagnit maydonlar nazariyasi", "Zamonaviy fizika asoslari", "Olimpiada masalalari uslublari"] },

// --- STARTUP CATEGORY (1 COURSE) — Prompt 4 ---
{ id: 36, title: "Startup boshlash (AI bilan)", category: "startup", catName: "Startup", desc: "AI vositalari yordamida g'oya validatsiyasi, MVP yaratish va O'zbekiston bozorida biznes ishga tushirish.", duration: "5 Hafta", level: "Boshlang'ich", price: "299,000 UZS", icon: "fa-solid fa-rocket", badge: "Biznes", modules: ["G'oya validatsiyasi va bozor tahlili", "MVP (Minimum Viable Product) yaratish", "O'zbekiston startap ekotizimi va grantlar", "AI vositalari bilan tez prototiplash"] }
    ];
