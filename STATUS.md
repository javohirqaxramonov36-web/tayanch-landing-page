...
| 2026-09-25 | Tuzatish — tekshiruv skriptlari | `services.html` va `index.html` dan 6 ta vaqtincha tekshiruv `<script>` bloki olib tashlandi (ulardan biri prodda 1.4s keyin ariza modalini avtomatik ochib qo'yardi). 0 qo'shimcha, 194 o'chirish | bdd8ef4 |
